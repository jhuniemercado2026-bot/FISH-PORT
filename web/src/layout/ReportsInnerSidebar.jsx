...
export const REPORT_TABS = [
  ...
  { key: "visiting-boats", label: "Visiting Boats", icon: IoBoatOutline },
  { key: "boat-types", label: "Boat Types", icon: IoBoatOutline },
  { key: "owner-info", label: "Boat Owner", icon: IoPeopleOutline },
  { key: "owner-signature", label: "Terms and Agreement", icon: IoDocumentTextOutline },
  ...
  { key: "collections", label: "Collections", icon: IoReceiptOutline },
  { key: "receivables", label: "Receivables", icon: IoReceiptOutline },
